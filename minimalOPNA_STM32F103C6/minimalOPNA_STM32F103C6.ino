...
void setupMCO() {
  ...
  // enabling MCO, HSI, using external clock source (this shiny 8mhz cristal, in case of STM32F103. no, not the 32768hz one, thats realtime clock you silly goober)
